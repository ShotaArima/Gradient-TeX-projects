...
\section{準備}
\input{contents/02_preparation.tex}

\section{従来手法}
\input{contents/03_default_method.tex}

\section{提案手法}
\input{contents/04_propose_method.tex}

\section{実験}
\input{contents/05_experiment}

\section{考察}
\input{contents/06_consideration}
...
% 謝辞
\acknowledgements
\input{contents/08_acknowledgements}
